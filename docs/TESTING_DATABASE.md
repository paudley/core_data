...
# Testing the Database with core\_data

core\_data bakes testing tooling into the image so both humans and agents can validate schema changes, stored procedures, and operational workflows quickly. This guide covers the main approaches: lightweight smoke checks, pgTap unit tests, automated CLI workflows, and integration-test strategies.
...
* Prefer ephemeral databases created via `docker compose up` against the core\_data image.
